...
public class GraphQLTypeMapperTest {
    ...
    public void testToSortBy_SCORE() {
        com.iccues.metaanimebackend.entity.SortBy result =
                graphQLTypeMapper.toSortBy(com.iccues.generated.types.SortBy.SCORE);
        assertEquals(com.iccues.metaanimebackend.entity.SortBy.SCORE, result);
    }

    @Test
    public void testToSortBy_POPULARITY() {
        com.iccues.metaanimebackend.entity.SortBy result =
                graphQLTypeMapper.toSortBy(com.iccues.generated.types.SortBy.POPULARITY);
        assertEquals(com.iccues.metaanimebackend.entity.SortBy.POPULARITY, result);
    }

    @Test
    public void testToSortBy_Null() {
        com.iccues.metaanimebackend.entity.SortBy result = graphQLTypeMapper.toSortBy(null);
        assertNull(result);
    }
    ...
    public void testToSeason_WINTER() {
        com.iccues.metaanimebackend.entity.Season result =
                graphQLTypeMapper.toSeason(com.iccues.generated.types.Season.WINTER);
        assertEquals(com.iccues.metaanimebackend.entity.Season.WINTER, result);
    }

    @Test
    public void testToSeason_SPRING() {
        com.iccues.metaanimebackend.entity.Season result =
                graphQLTypeMapper.toSeason(com.iccues.generated.types.Season.SPRING);
        assertEquals(com.iccues.metaanimebackend.entity.Season.SPRING, result);
    }

    @Test
    public void testToSeason_SUMMER() {
        com.iccues.metaanimebackend.entity.Season result =
                graphQLTypeMapper.toSeason(com.iccues.generated.types.Season.SUMMER);
        assertEquals(com.iccues.metaanimebackend.entity.Season.SUMMER, result);
    }

    @Test
    public void testToSeason_FALL() {
        com.iccues.metaanimebackend.entity.Season result =
                graphQLTypeMapper.toSeason(com.iccues.generated.types.Season.FALL);
        assertEquals(com.iccues.metaanimebackend.entity.Season.FALL, result);
    }

    @Test
    public void testToSeason_Null() {
        com.iccues.metaanimebackend.entity.Season result = graphQLTypeMapper.toSeason(null);
        assertNull(result);
    }
    ...
    public void testToGraphQLAnime_AllFields() {
        com.iccues.generated.types.Anime result = graphQLTypeMapper.toGraphQLAnime(testAnime);
    ...
    public void testToGraphQLMapping_AllFields() {
        ...
        com.iccues.generated.types.Mapping result = graphQLTypeMapper.toGraphQLMapping(mapping);

        assertNotNull(result);
        // mappingId: Long -> String
        assertEquals("10", result.getMappingId());
        assertEquals(com.iccues.generated.types.Platform.AniList, result.getSourcePlatform());
