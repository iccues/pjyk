...
public class GraphQLTypeMapperTest {
    ...
    public void testToSortBy_SCORE() {
        com.yukiani.server.entity.SortBy result =
                graphQLTypeMapper.toSortBy(com.yukiani.server.generated.types.SortBy.SCORE);
        assertEquals(com.yukiani.server.entity.SortBy.SCORE, result);
    }

    @Test
    public void testToSortBy_POPULARITY() {
        com.yukiani.server.entity.SortBy result =
                graphQLTypeMapper.toSortBy(com.yukiani.server.generated.types.SortBy.POPULARITY);
        assertEquals(com.yukiani.server.entity.SortBy.POPULARITY, result);
    }

    @Test
    public void testToSortBy_Null() {
        com.yukiani.server.entity.SortBy result = graphQLTypeMapper.toSortBy(null);
        assertNull(result);
    }
    ...
    public void testToSeason_WINTER() {
        com.yukiani.server.entity.Season result =
                graphQLTypeMapper.toSeason(com.yukiani.server.generated.types.Season.WINTER);
        assertEquals(com.yukiani.server.entity.Season.WINTER, result);
    }

    @Test
    public void testToSeason_SPRING() {
        com.yukiani.server.entity.Season result =
                graphQLTypeMapper.toSeason(com.yukiani.server.generated.types.Season.SPRING);
        assertEquals(com.yukiani.server.entity.Season.SPRING, result);
    }

    @Test
    public void testToSeason_SUMMER() {
        com.yukiani.server.entity.Season result =
                graphQLTypeMapper.toSeason(com.yukiani.server.generated.types.Season.SUMMER);
        assertEquals(com.yukiani.server.entity.Season.SUMMER, result);
    }

    @Test
    public void testToSeason_FALL() {
        com.yukiani.server.entity.Season result =
                graphQLTypeMapper.toSeason(com.yukiani.server.generated.types.Season.FALL);
        assertEquals(com.yukiani.server.entity.Season.FALL, result);
    }

    @Test
    public void testToSeason_Null() {
        com.yukiani.server.entity.Season result = graphQLTypeMapper.toSeason(null);
        assertNull(result);
    }
    ...
    public void testToGraphQLAnime_AllFields() {
        com.yukiani.server.generated.types.Anime result = graphQLTypeMapper.toGraphQLAnime(testAnime);
    ...
    public void testToGraphQLMapping_AllFields() {
        ...
        com.yukiani.server.generated.types.Mapping result = graphQLTypeMapper.toGraphQLMapping(mapping);

        assertNotNull(result);
        // mappingId: Long -> String
        assertEquals("10", result.getMappingId());
        assertEquals(com.yukiani.server.generated.types.Platform.AniList, result.getSourcePlatform());
