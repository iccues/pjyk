...
public class AdminAnimeControllerTest {
    ...
    public void testDeleteAnime_WithMappings() throws Exception {
        ...
        // 创建一个映射并关联到这个动画
        com.yukiani.entity.Mapping mapping = new com.yukiani.entity.Mapping();
        ...
        com.yukiani.entity.Mapping updatedMapping = mappingRepository.findById(mappingId).orElseThrow();
