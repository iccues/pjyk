...
public class AnimeSpecTest {
    ...
    public void testOrderBy_WithScoreSortBy() {
        ...
        // 使用 SCORE 排序
        Specification<Anime> spec = AnimeSpec.orderBy(com.yukiani.entity.SortBy.SCORE);
        List<Anime> result = animeRepository.findAll(spec);
    ...
    public void testOrderBy_WithPopularitySortBy() {
        ...
        // 使用 POPULARITY 排序
        Specification<Anime> spec = AnimeSpec.orderBy(com.yukiani.entity.SortBy.POPULARITY);
        List<Anime> result = animeRepository.findAll(spec);
